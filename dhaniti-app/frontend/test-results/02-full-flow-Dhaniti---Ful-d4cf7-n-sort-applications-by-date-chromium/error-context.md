...
- Name: 02-full-flow.spec.js >> Dhaniti - Full Application E2E Flow >> User can sort applications by date
- Location: e2e\02-full-flow.spec.js:333:3
...
Locator: getByRole('button', { name: /date/i })
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('button', { name: /date/i })
