...
- Name: 02-full-flow.spec.js >> Dhaniti - Full Application E2E Flow >> User can sort applications by credit
- Location: e2e\02-full-flow.spec.js:315:3
...
Locator: getByRole('button', { name: /credit/i })
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('button', { name: /credit/i })
